...
import { DeleteModal, Title, ColumnContainer, ButtonContainer, Subtitle } from './UpsertUser.style'
...
const DeleteUser = props => {
  ...
  const validation = () => {
    setPostLoading(true)
    axios.get(`${BACKEND.DELETE_USER}/${dataItem.uuid}`, {
      headers: {
...
export default withCookies(DeleteUser);
